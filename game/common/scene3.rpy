...
label common_scene3:
    ...
    "The different orientation groups finally diffuse as older students start to escort their respective mobs further into the university."
    ...
    "I flip through a few headlines of the campus news site:"
        ...
        "Top Ten Shows You Have to Watch as a Pre-Med!":
            ...
            menu:
                    "Bell University for the Third Year in a Row":
                        ...
                        "This university is notorious for keeping to its standards at any cost. I heard the school nearly burned down because of nearby wildfires and the air became horribly polluted. Even then, classes still continued."
    ...
    "I could go back to the dorms for now and walk around the main street and see what the city looks like at night."
    
    "There were a lot of dormant neon signs as I walked with Cora and Vi to this meeting place, so it might be interesting to see what kind of shops they are."
    ...
    show ch dwinelle with dissolve
    
    "A tall woman with puffy blonde hair stops just short of where I’m standing, catching her breath from under the large, green gate."
    
    "As she runs/stumbles towards my direction, she clutches a stack of wrinkled papers in one hand, while keeping herself steady by holding her knee with her other hand."
    
    "She’s not showing the same fatigue on her face as the rest of her body. Instead, she gives a big grin."
    ...
    "Rosa shakes her head and laughs, as if I just said something incredulous."
